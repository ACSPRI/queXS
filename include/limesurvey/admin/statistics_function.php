        ...
        if (isset($summary) && $summary)
        {
            ...
            foreach ($runthrough as $rt)
            {
                ...
                elseif ($firstletter == "R")
                {
                    ...
                    $query .= " FROM ".db_table_name("survey_$surveyid");
		    ...
		    $query .= " WHERE ".db_quote_id($fieldname)." IS NOT NULL";
                        ...
                        //get data
                        $query ="SELECT ".db_quote_id($fieldname)." FROM ".db_table_name("survey_$surveyid");
		    ...
		    $query .= " WHERE ".db_quote_id($fieldname)." IS NOT null";
                    ...
                    $querystarter="SELECT ".db_quote_id($fieldname)." FROM ".db_table_name("survey_$surveyid");
		    ...
		    $querystarter.=" WHERE ".db_quote_id($fieldname)." IS NOT null";
