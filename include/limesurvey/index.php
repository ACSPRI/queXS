			...
			if (count($quota['members']) > 0) // Quota can't be empty
			{
				...
				foreach($quota['members'] as $member)
				{
					...
					foreach($member['fieldnames'] as $fieldname)
					{
						...
						$fields_query[] = "s." . db_quote_id($fieldname)." = '{$member['value']}'";
				...
				{
					//Make sure to only check completions for this current questionnaire and sample (based on current case_id)
