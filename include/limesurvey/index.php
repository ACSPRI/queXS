 ...
 *
 * $Id: index.php 10930 2011-09-02 16:01:47Z c_schmitz $
 */
...
queXS Removal */
    ...
    $_SESSION['holdname']=$_POST['token']; //Session variable used to load answers every page. //queXS update
    $_SESSION['holdpass']=$_POST['token']; //Session variable used to load answers every page. //queXS update

    if ($errormsg == "") loadanswers();
    $move = "movecurrent"; //queXS Change
...
{
    //echo "<script language='JavaScript'> $(document).ready( function() {alert('".$clang->gT("Your responses were successfully saved.","js")."');}) </script>"; //queXS Removal
}
