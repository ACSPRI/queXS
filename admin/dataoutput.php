...
if ($questionnaire_id)
{
	...
	print "&emsp;<a href='" . $ls['entry_url'] . "/admin/responses/sa/index/surveyid/$lsid' class='btn btn-default fa btn-lime'>".  T_("Download data for this questionnaire via Limesurvey") . "</a></div>";
